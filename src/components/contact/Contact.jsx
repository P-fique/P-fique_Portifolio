      ...
      <div className="contact__content">
        ...
        <div className="contact__info">
          <div className="contact__card">
            ...
            <span className="contact__card-data">pfique.tuyizere@gmail.com</span>
          ...
          <div className="contact__card">
            ...
            <span className="contact__card-data">250 780 478 405</span>
            <a href="https://wa.me/250780478405" className="contact__button">
          ...
          <div className="contact__card">
            ...
            <span className="contact__card-data">P LOCAL</span>
