...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Pacifique TUYIZERE
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                >
                 ...
                 <h3 className="">Full Stack Developer | Video Editor | Writer</h3>

                 <p className="home__description">
                    I am a web developer, video editor, song Writer located in Kigali -Rwanda. I am passionate and open to work anytime, anywhere.
                 </p>
